...
/// <summary>
/// Skill that enables the comprehension of mathematical problems presented in English / natural-language text, 
/// followed by the execution of the necessary calculations to solve those problems.
/// </summary>
...
";
    ...
    private static string EvaluateMathExpression(Match match)
    {
        ...
        var expr = new NCalc.Expression(textExpressions, EvaluateOptions.IgnoreCase);
